        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="GET">
            <div class="form-row">
                <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6">
                    <div class="form-group"><label class="text-dark">Department</label><select class="form-control"><option value="All" selected="">All</option><option value="Multipurpose Hall">Multipurpose Hall</option><option value="Multipurpose Room">Multipurpose Room</option><option value="Dewan Tunku Canselor">Dewan Tunku Canselor</option></select></div>
                </div>
                <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6">
                    <div class="form-group"><label class="text-dark">Category</label><select class="form-control"><option value="All" selected="">All</option><option value="Multipurpose Hall">Multipurpose Hall</option><option value="Multipurpose Room">Multipurpose Room</option><option value="Dewan Tunku Canselor">Dewan Tunku Canselor</option></select></div>
                </div>
            </div>
            <div class="form-row">
                <div class="col-sm-12">
                    <div class="form-group"><label class="text-dark">Maximum Capacity</label><input class="form-control" type="number"></div>
                </div>
            </div>
            <div class="form-row justify-content-center">
                ...
                <input class="btn btn-primary text-center align-items-center" type="submit" style="width: 100%;">
            </div>
            </div>
        </form>
    ...
    <div class="container" style="margin-bottom: 50px;">
        <div class="row row-cols-sm-1 row-cols-md-4 row-cols-lg-4 row-cols-xl-4 justify-content-sm-center">
            <?php 
                ...
                <div class="card shadow-sm"><img class="card-img-top w-100 d-block" src="assets/img/dtc.jpg"
                        style="min-height: 137.484px;max-height: 200px;height: 200px;">
                    <div class="card-body">
                        <h4 class="text-dark card-title">Dewan Tunku Canselor</h4>
                        <div class="d-flex">
                            <div class="row row-cols-2" style="max-width: 420px;min-width: 300px;">
                                <div class="col-2 col-lg-2" style="max-width: 10%;"><i class="fa fa-location-arrow"
                                        ...
                                        style="color: rgb(52,58,64);" title="Address"></i></div>
                                <div class="col-10 col-lg-10" style="max-width: 90%;">
                                    <h6 class="text-muted mb-2">Cultural Centre University Of Malaya 50603 Kuala
                                        Lumpur<br></h6>
                                </div>
